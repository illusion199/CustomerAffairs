        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 offset-md-1">
                <div class="sign-form">
                    ...
                    <form method="POST" action="{{route('business.register')}}" method="post">
                        {{csrf_field()}}
                        {{-- @section('editMethod')
                        @sho --}}
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('firstName') ? ' is-invalid' : '' }}"
                                        name="firstName" value="{{ old('name') }}" placeholder="First Name">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('lastName') ? ' is-invalid' : '' }}"
                                        name="lastName" value="{{ old('name') }}" placeholder="Last name">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                        name="email" value="{{ old('name') }}" placeholder="Email">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"
                                        name="password" value="{{ old('name') }}" placeholder="Password">
                            ...
                            <div class="col-sm-12">
                                <div class="form-check check-link pb-15">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="agreed" value="checked">
                                        I agree to
                                ...
                                <div class="form-check check-link pb-15">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="spEmail" value="checked">
